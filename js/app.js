...
pokemons.push(
    {
        nombre:"Charmander",
        tipo:"Fuego",
        img:"https://oyster.ignimgs.com/mediawiki/apis.ign.com/pokemon-blue-version/d/d4/Charmander.gif?width=1600"

    },
    {
        nombre:"Squirtle",
        tipo: "Agua",
        img: "https://ssb.wiki.gallery/images/7/79/Squirtle_SSBU.png"
    }
)

/* console.log(pokemons) */

/* 2 - Esta función crearHTMLPokemon(pokemon) crea un el código HTML de un elemento <li> con los datos del Pokemon que reciba como parámetro.
